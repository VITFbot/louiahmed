...
def start(message):
	...
	if f == SUDO:
		...
		M = types.InlineKeyboardButton('DEV', url='https://t.me/TAILSSILVEP')
		mas.add(G,K)
		mas.add(V)
		mas.add(M)
		...
		me = types.InlineKeyboardButton(text="سورس جيري وان ",url="https://t.me/Jerry_vip")
		ch = types.InlineKeyboardButton(text="▶ قناة البوت ◀",url="https://t.me/TAILSSILVEP")
		rr.add(me,he,de)
		rr.add(ch)
	...
	if call.data =="Y_U_8":
		...
		while True:
			...
			if response.text.find('If you have <strong>Telegram</strong>, you can contact <a class="tgme_username_link"')>=0 and j not in ban:
				...
				R = types.InlineKeyboardButton(f'{sk}', callback_data="1x")
				Y_U_8 = types.InlineKeyboardButton('DEV', url='https://t.me/TAILSSILVEP')
